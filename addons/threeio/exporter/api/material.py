...
def blending(material):
    ...
    try:
        blend = material.threeio_blending_type
    except AttributeError:
        logger.debug('No threeio_blending_type attribute found')
...
def depth_test(material):
    ...
    try:
        test = material.threeio_depth_test
    except AttributeError:
        logger.debug('No threeio_depth_test attribute found')
        test = True
    return test
...
def depth_write(material):
    ...
    try:
        write = material.threeio_depth_write
    except AttributeError:
        logger.debug('No threeio_depth_write attribute found')
        write = True
    return write
...
def visible(material):
    ...
    try:
        vis = material.threeio_visible
    except AttributeError:
        logger.debug('No threeio_visible attribute found')
        vis = True
